...
import { ShieldCheck, Eye, Settings, LogOut, Download, Sparkles } from 'lucide-react';

export const AdminBar: React.FC = () => {
  const { isAdmin, viewMode, setViewMode, logoutAdmin, exportBackupJSON } = useDataContext();
